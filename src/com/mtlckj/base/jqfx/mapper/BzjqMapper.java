...
public interface BzjqMapper {
	 ...
	 * @return
	 */
	Integer countByWeek(Map<String, Object> params);
	/**
	 * 
	* @Function: BzjqMapper.java
	* @Description: 按小时统计
	*
	* @param:@param params
	* @param:@return
	...
	* 2019年1月7日      唐青                                        v1.0.0               修改原因
	 */
	List<Wffzjq> countByHours(Map<String, Object> params);
	/**
	 * 警情列表
	 * 
	 * @return
	...
	Integer getWffzCount(Map<String, Object> params);
}
