...
public interface ZtypService {
	
	/**
	 * 
	* @Function: ZtypService.java
	* @Description: 警情走势图
	*
	* @param:@param map
	* @param:@return
	...
	* 2018年10月30日      唐青                                        v1.0.0               修改原因
	 */
	List<Map<String,String> > getJqlbtj(Map<String,Object> map);
