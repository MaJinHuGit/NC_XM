...
function eConsole(param) {
	//alert(param.name)
	loadGwqyList(param.name,fztype);
}
 ...
 * @returns
 */
function getGwqyTjt(fztype) {
	var url = "../jqfx/ztyp/getGwqyTjt";
	$.get(url, {
