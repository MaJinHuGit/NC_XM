...
window.Win10 = {
    ...
    _init:function () {
        ...
        $("#win10-btn-browser").click(function () {
          ...
          /*  layer.prompt({
        	...
        	Win10.openUrl('./frame/plugins/browser/b.html','<i class="fa fa-internet-explorer icon blue"></i>浏览器' );
        ...
        Win10.setContextMenu('#win10>.desktop',[
            ...
            ['<i class="fa fa-fw fa-picture-o"></i> '+Win10.lang('切换壁纸','theme'),function () { Win10.openUrl("./frame/plugins/theme_switcher/theme_switcher.html" , '<i class="icon fa fa-fw fa-picture-o blue" ></i>切换壁纸'  ); }], 
			['<i class="fa fa-fw  fa-internet-explorer"></i> '+Win10.lang('打开浏览器','open browser'),function () { Win10.openUrl('./frame/plugins/browser/b.html','<i class="fa fa-internet-explorer icon blue"></i>浏览器' ); }],
    ...
    openUrl: function (url, title,areaAndOffset) {
        ...
        if (!url) {
            url = './frame/plugins/browser/b.html';
        }
        if (!title) {
            title = url;
        }
        ...
        //<a class="win10-btn-change-url" index="' + index + '" title="'+Win10.lang('修改地址','Change URL')+'" href="javascript:void(0)"><span class="fa fa-chain"></span></a> 
